    ...
    loadQuestion: function t() {
        ...
        app.util.request({
            ...
            success: function t(e) {
                var i = e.data;
                console.log(e)
                if ( i.data.list == undefined ) {
                  return;
                }
                for (var s = [], n = 0, answer_arr = []; n < i.data.list.right_answer_arr.length; n++) {
                  s.push({
                    text: "",
                    state: -1
                  });
                  answer_arr.push({
                    text: i.data.list.right_answer_arr[n],
                    state: 0
                  });
                }
                a.shuffle(answer_arr);
